...
// ============================================================
// 5. Quiz – 20 perguntas por nível (Fácil, Médio, Difícil)
// com campo 'explicacao'
// ============================================================
const QUIZ = {
    "Fácil": [
        { pergunta: "Qual dinossauro é conhecido como 'Rei dos Dinossauros'?", opcoes: ["Triceratops", "Velociraptor", "Tyrannosaurus rex", "Braquiossauro"], resposta: 2, explicacao: "O Tiranossauro rex (T. rex) é famoso por seu tamanho e força, sendo um dos maiores carnívoros terrestres." },
        { pergunta: "O que significa a palavra 'dinossauro'?", opcoes: ["Lagarto terrível", "Lagarto antigo", "Ave do trovão", "Monstro gigante"], resposta: 0, explicacao: "Do grego 'deinos' (terrível) + 'sauros' (lagarto). Foi cunhado por Richard Owen em 1842." },
        { pergunta: "Em qual período viveu o Tiranossauro rex?", opcoes: ["Jurássico", "Triássico", "Cretáceo", "Permiano"], resposta: 2, explicacao: "O T. rex viveu no final do Cretáceo, cerca de 68-66 milhões de anos atrás." },
        { pergunta: "Quantos chifres o Triceratops tinha no rosto?", opcoes: ["1", "2", "3", "4"], resposta: 2, explicacao: "O Triceratops tinha três chifres: dois sobre os olhos e um menor no nariz." },
        { pergunta: "Qual desses dinossauros era herbívoro?", opcoes: ["Velociraptor", "Estegossauro", "Espinossauro", "Alossauro"], resposta: 1, explicacao: "O Estegossauro era herbívoro, alimentava-se de plantas baixas, enquanto os demais são carnívoros ou piscívoros." },
        { pergunta: "Os dinossauros viveram na Era...", opcoes: ["Cenozoica", "Paleozoica", "Mesozoica", "Proterozoica"], resposta: 2, explicacao: "A Era Mesozoica é dividida em Triássico, Jurássico e Cretáceo, período em que os dinossauros dominaram a Terra." },
        { pergunta: "Qual das opções é um dinossauro voador?", opcoes: ["Pterodáctilo", "Arqueoptérix", "Microraptor", "Nenhuma das anteriores"], resposta: 1, explicacao: "O Arqueoptérix é considerado o primeiro dinossauro com penas e capaz de voar (ou planar), sendo um elo entre dinossauros e aves." },
        { pergunta: "Qual dinossauro tinha placas nas costas?", opcoes: ["Tiranossauro", "Velociraptor", "Estegossauro", "Braquiossauro"], resposta: 2, explicacao: "O Estegossauro possuía placas ósseas ao longo da coluna, usadas para termorregulação e defesa." },
        { pergunta: "O que os dinossauros carnívoros comiam?", opcoes: ["Plantas", "Insetos", "Outros animais", "Pedras"], resposta: 2, explicacao: "Carnívoros alimentam-se de carne de outros animais. Exemplos: T. rex, Velociraptor." },
        { pergunta: "Qual era o maior dinossauro carnívoro?", opcoes: ["T-Rex", "Espinossauro", "Giganotossauro", "Carcharodontossauro"], resposta: 1, explicacao: "O Espinossauro é considerado o maior carnívoro, chegando a 15 m de comprimento, superando o T. rex." },
        { pergunta: "Os dinossauros botavam ovos?", opcoes: ["Sim, todos", "Não, alguns nasciam vivos", "Apenas os herbívoros", "Apenas os carnívoros"], resposta: 0, explicacao: "Todos os dinossauros eram ovíparos, ou seja, botavam ovos, como evidenciado por ninhos e ovos fossilizados." },
        { pergunta: "Qual desses viveu no período Jurássico?", opcoes: ["Triceratops", "Braquiossauro", "Tiranossauro rex", "Velociraptor"], resposta: 1, explicacao: "O Braquiossauro viveu no Jurássico Superior, enquanto os demais são do Cretáceo." },
        { pergunta: "O fêmur é um osso da...", opcoes: ["Cabeça", "Perna", "Cauda", "Costas"], resposta: 1, explicacao: "O fêmur é o osso da coxa, o mais longo e resistente do corpo, importante para estimar a massa de dinossauros." },
        { pergunta: "Qual dinossauro tinha uma 'vela' nas costas?", opcoes: ["Espinossauro", "T-Rex", "Diplodoco", "Paquicefalossauro"], resposta: 0, explicacao: "O Espinossauro possuía longas espinhas neurais que formavam uma vela, provavelmente usada para termorregulação ou exibição." },
        { pergunta: "Como chamamos os dinossauros com 'pés de lagarto'?", opcoes: ["Ornitísquios", "Saurísquios", "Terópodes", "Saurópodes"], resposta: 1, explicacao: "Saurísquios ('quadril de lagarto') é um dos dois grandes grupos de dinossauros, incluindo terópodes e saurópodes." },
        { pergunta: "Qual dinossauro usava uma clava (bola) na ponta da cauda?", opcoes: ["Anquilossauro", "Estegossauro", "Triceratops", "Parassaurolofo"], resposta: 0, explicacao: "O Anquilossauro tinha uma cauda com uma clava óssea, usada como arma defensiva contra predadores." },
        { pergunta: "Os dinossauros e os seres humanos viveram na mesma época?", opcoes: ["Sim", "Não, os dinossauros sumiram antes", "Sim, na Era do Gelo", "Apenas na África"], resposta: 1, explicacao: "Os dinossauros não-avianos foram extintos há 66 milhões de anos, muito antes do surgimento dos humanos." },
        { pergunta: "Qual dinossauro tinha garras gigantes, mas era herbívoro?", opcoes: ["Therizinosaurus", "Deinonychus", "Velociraptor", "Utahraptor"], resposta: 0, explicacao: "O Therizinosaurus possuía garras de até 1 metro, mas era herbívoro, usando-as para alcançar folhas." },
        { pergunta: "Em que continente foi encontrado o primeiro fóssil de T-Rex?", opcoes: ["África", "América do Norte", "Ásia", "Europa"], resposta: 1, explicacao: "O primeiro fóssil de T. rex foi descoberto nos EUA (América do Norte) em 1902." },
        { pergunta: "Qual desses é um dinossauro bico de pato?", opcoes: ["Estegossauro", "Edmontossauro", "Paquicefalossauro", "Protocerátops"], resposta: 1, explicacao: "Os hadrossauros (bico de pato) incluem o Edmontossauro, com dentes especializados para triturar plantas." }
    ],
    "Médio": [
        { pergunta: "Qual dinossauro possuía uma vela neural nas costas?", opcoes: ["Espinossauro", "Estegossauro", "Triceratops", "Velociraptor"], resposta: 0, explicacao: "A vela do Espinossauro era formada por espinhas neurais alongadas, possivelmente para termorregulação ou exibição." },
        { pergunta: "A circunferência do fêmur é usada para estimar:", opcoes: ["Velocidade", "Massa corporal", "Idade", "Dieta"], resposta: 1, explicacao: "Estudos mostram que a circunferência do fêmur se correlaciona com a massa corporal, sendo usada para estimar o peso de dinossauros." },
        { pergunta: "Qual icnogênero tem 3 dedos, garras e tamanho pequeno (<25cm)?", opcoes: ["Eubrontes", "Grallator", "Megalosauripus", "Amblydactylus"], resposta: 1, explicacao: "Grallator é um icnogênero de pegadas pequenas (menos de 25 cm), com 3 dedos e garras, associado a terópodes primitivos." },
        { pergunta: "No modelo da Extinção K-Pg, o que representa a letra 'P'?", opcoes: ["Predadores", "Plantas", "Presas", "População total"], resposta: 1, explicacao: "No modelo Lotka-Volterra, P representa a população de plantas (produtores primários), base da cadeia alimentar." },
        { pergunta: "Qual período geológico é conhecido como 'Era dos Dinossauros'?", opcoes: ["Permiano", "Triássico", "Jurássico", "Cretáceo"], resposta: 2, explicacao: "O Jurássico (201-145 Ma) é frequentemente chamado de 'Era dos Dinossauros' devido à sua diversificação e domínio." },
        { pergunta: "O Estegossauro viveu em qual período?", opcoes: ["Triássico", "Jurássico", "Cretáceo", "Permiano"], resposta: 1, explicacao: "O Estegossauro viveu no Jurássico Superior, há cerca de 155-150 milhões de anos." },
        { pergunta: "Qual dinossauro tinha um 'capacete' ósseo na cabeça?", opcoes: ["Paquicefalossauro", "Carnotauro", "Ceratossauro", "Protocerátops"], resposta: 0, explicacao: "O Paquicefalossauro possuía um crânio com domo ósseo de até 25 cm de espessura, usado em combates cabeça-a-cabeça." },
        { pergunta: "O que são icnofósseis?", opcoes: ["Fósseis de ossos", "Fósseis de ovos", "Vestígios de atividade", "Fósseis de plantas"], resposta: 2, explicacao: "Icnofósseis são marcas de atividade biológica, como pegadas, trilhas e tocas, que fornecem informações sobre o comportamento." },
        { pergunta: "Qual dinossauro é famoso por ter três chifres e um grande folho?", opcoes: ["Triceratops", "Estiracossauro", "Casmossauro", "Protocerátops"], resposta: 0, explicacao: "O Triceratops é o ceratopsiano mais conhecido, com três chifres e um grande folho ósseo." },
        { pergunta: "O Velociraptor pertencia à família:", opcoes: ["Tiranossaurídeos", "Dromaeossaurídeos", "Ceratopsídeos", "Hadrossaurídeos"], resposta: 1, explicacao: "Velociraptor é um dromaeossaurídeo, grupo de dinossauros com garras em foice e penas." },
        { pergunta: "A Teoria do Impacto de Alvarez explica:", opcoes: ["A deriva continental", "A extinção K-Pg", "O surgimento das aves", "A formação dos fósseis"], resposta: 1, explicacao: "A teoria de Alvarez propõe que um asteroide impactou a Terra há 66 Ma, causando a extinção dos dinossauros não-avianos." },
        { pergunta: "Qual desses dinossauros viveu no Triássico?", opcoes: ["Alossauro", "Coelophysis", "T-Rex", "Braquiossauro"], resposta: 1, explicacao: "Coelophysis é um dos primeiros dinossauros, datado do Triássico Superior (cerca de 230 Ma)." },
        { pergunta: "A silhueta placeholder é gerada quando:", opcoes: ["A imagem é muito grande", "Falta a imagem real", "O dinossauro é desconhecido", "Há erro no código"], resposta: 1, explicacao: "Quando a imagem real não está disponível, o código gera uma silhueta genérica via canvas." },
        { pergunta: "No modelo Lotka-Volterra, quem são os predadores de topo?", opcoes: ["Plantas", "Herbívoros", "Carnívoros", "Onívoros"], resposta: 2, explicacao: "Os carnívoros (C) são os predadores de topo, controlando as populações de herbívoros." },
        { pergunta: "Qual continente já foi parte de Gondwana?", opcoes: ["América do Norte", "África", "Europa", "Ásia"], resposta: 1, explicacao: "Gondwana incluía a África, América do Sul, Austrália, Antártida e Índia." },
        { pergunta: "Qual a dieta do Espinossauro?", opcoes: ["Carnívoro", "Herbívoro", "Piscívoro", "Onívoro"], resposta: 2, explicacao: "O Espinossauro era piscívoro, alimentando-se principalmente de peixes, como indicado por seus dentes cônicos." },
        { pergunta: "O que significa 'pneumatização' em dinossauros?", opcoes: ["Ossos ocos", "Pulmões grandes", "Sangue quente", "Voo"], resposta: 0, explicacao: "Pneumatização refere-se a ossos com espaços aéreos, reduzindo o peso. É comum em saurópodes e terópodes." },
        { pergunta: "Qual dinossauro tinha uma crista tubular oca?", opcoes: ["Parassaurolofo", "Lambeossauro", "Corythosaurus", "Maiassaura"], resposta: 0, explicacao: "Parasaurolophus possuía uma crista tubular oca, possivelmente usada para produzir sons." },
        { pergunta: "Em que era os dinossauros surgiram?", opcoes: ["Mesozoica", "Paleozoica", "Cenozoica", "Proterozoica"], resposta: 0, explicacao: "Os dinossauros surgiram no início da Era Mesozoica, no Triássico (cerca de 230 Ma)." },
        { pergunta: "Qual o nome do supercontinente que existia no Triássico?", opcoes: ["Laurásia", "Gondwana", "Pangeia", "Rodínia"], resposta: 2, explicacao: "Pangeia era o supercontinente único que existiu no Triássico, antes de se fragmentar." }
    ],
    "Difícil": [
        { pergunta: "No modelo K-Pg, o parâmetro 'r' é afetado por:", opcoes: ["Chuva ácida", "Bloqueio solar", "Predação", "Mortalidade"], resposta: 1, explicacao: "r é a taxa de crescimento das plantas, reduzida pelo bloqueio solar causado pela poeira do impacto." },
        { pergunta: "Qual icnogênero tem 3 dedos, sem garras e tamanho grande (>25cm)?", opcoes: ["Grallator", "Eubrontes", "Amblydactylus", "Wintonopus"], resposta: 2, explicacao: "Amblydactylus é um icnogênero de pegadas grandes (acima de 25 cm) com 3 dedos e sem garras, associado a hadrossauros." },
        { pergunta: "Os dinossauros Saurísquios se dividem em:", opcoes: ["Terópodes e Saurópodes", "Ornitópodes e Ceratopsídeos", "Estegossauros e Anquilossauros", "Hadrossauros e Paquicefalossauros"], resposta: 0, explicacao: "Os Saurísquios incluem dois grandes grupos: Terópodes (carnívoros) e Saurópodes (herbívoros de pescoço longo)." },
        { pergunta: "Qual dinossauro tinha uma garra retrátil em forma de foice?", opcoes: ["T-Rex", "Deinonychus", "Espinossauro", "Carnotauro"], resposta: 1, explicacao: "Deinonychus possuía uma garra em foice no segundo dedo do pé, usada para atacar presas." },
        { pergunta: "Segundo Campione & Evans, a massa é proporcional a qual potência da circunferência femoral?", opcoes: ["1.5", "2.0", "2.73", "3.14"], resposta: 2, explicacao: "A equação de Campione & Evans (2012) usa a potência 2.73 para bípedes e 2.75 para quadrúpedes." },
        { pergunta: "Qual é o significado de 'K-Pg' na extinção?", opcoes: ["Cretáceo-Paleógeno", "K-Permiano", "Jurássico-Cretáceo", "Carbonífero-Permiano"], resposta: 0, explicacao: "K-Pg refere-se ao limite Cretáceo-Paleógeno (antigo K-T), marcando a extinção em massa." },
        { pergunta: "No jogo Paleo-Detetive, qual característica distingue Brontopodus de Parabrontopodus?", opcoes: ["Número de dedos", "Presença de garras", "Largura da pegada", "Tamanho"], resposta: 2, explicacao: "Brontopodus tem pegadas mais largas (proporção larga), enquanto Parabrontopodus tem pegadas mais estreitas." },
        { pergunta: "Qual dinossauro possuía ossos pneumáticos para reduzir peso?", opcoes: ["T-Rex", "Braquiossauro", "Triceratops", "Estegossauro"], resposta: 1, explicacao: "Saurópodes como o Braquiossauro tinham ossos pneumáticos (com cavidades de ar) para reduzir o peso do corpo enorme." },
        { pergunta: "O glóbulo interativo do Ancient Earth usa qual modelo?", opcoes: ["GPlates", "Paleomap", "EarthByte", "Paleobiology Database"], resposta: 2, explicacao: "O Ancient Earth Globe é baseado no modelo EarthByte, que reconstrui a paleogeografia ao longo do tempo." },
        { pergunta: "O que o parâmetro 'e' representa no modelo Lotka-Volterra?", opcoes: ["Taxa de crescimento", "Taxa de consumo", "Taxa de predação", "Mortalidade"], resposta: 2, explicacao: "e representa a taxa de predação de herbívoros por carnívoros (eficiência de caça)." },
        { pergunta: "Qual o menor dinossauro mesozoico conhecido?", opcoes: ["Microraptor", "Compsognathus", "Oculudentavis", "Anchiornis"], resposta: 2, explicacao: "Oculudentavis, descoberto em âmbar, é um dos menores dinossauros, com crânio de cerca de 1,5 cm." },
        { pergunta: "A equação Massa = a × (Circunferência_mm)^b é baseada em:", opcoes: ["Estudo de dinossauros bípedes", "Escala universal", "Apenas quadrúpedes", "Fósseis marinhos"], resposta: 1, explicacao: "Campione & Evans propuseram uma escala universal para tetrápodes terrestres, aplicável a bípedes e quadrúpedes." },
        { pergunta: "Qual a altitude aproximada do sítio de Ischigualasto?", opcoes: ["Nível do mar", "~700 m", "~2000 m", "~4000 m"], resposta: 1, explicacao: "O Parque Ischigualasto (Argentina) está a cerca de 700 metros de altitude, onde são encontrados fósseis do Triássico." },
        { pergunta: "O que significa 'mesotermia'?", opcoes: ["Sangue frio", "Sangue quente", "Temperatura intermediária", "Fotossíntese"], resposta: 2, explicacao: "Mesotermia é um termo usado para descrever dinossauros com metabolismo intermediário entre ectotérmicos e endotérmicos." },
        { pergunta: "Quantos milhões de anos atrás ocorreu a extinção K-Pg?", opcoes: ["65", "66", "100", "150"], resposta: 1, explicacao: "A extinção K-Pg ocorreu há cerca de 66 milhões de anos, no final do Cretáceo." },
        { pergunta: "Qual dinossauro foi encontrado abraçado a um Velociraptor?", opcoes: ["Protocerátops", "Psitacossauro", "Triceratops", "Estegossauro"], resposta: 0, explicacao: "O fóssil de Protocerátops e Velociraptor em luta mortal é um dos mais famosos, preservado na Mongólia." },
        { pergunta: "No método RK4 aplicado na extinção, qual é o passo de tempo (dt) usado?", opcoes: ["0.1 anos", "0.5 anos", "1 ano", "2 anos"], resposta: 1, explicacao: "O código usa dt = 0.5 anos para garantir precisão na integração numérica do modelo Lotka-Volterra." },
        { pergunta: "Qual a principal evidência de cuidado parental em Maiassaura?", opcoes: ["Ovos isolados", "Ninhos coloniais", "Cráneos pequenos", "Penas"], resposta: 1, explicacao: "Maiasaura ('lagarto boa mãe') tinha ninhos em colônias e evidências de que os filhotes eram alimentados após o nascimento." },
        { pergunta: "A fórmula para massa de quadrúpedes usa valores de a e b:", opcoes: ["a=0.00016, b=2.73", "a=0.00049, b=2.75", "a=0.001, b=2.5", "a=0.0001, b=3.0"], resposta: 1, explicacao: "Para quadrúpedes, a equação de Campione & Evans usa a=0.00049 e b=2.75." },
        { pergunta: "Qual dinossauro possuía espinhos neurais alongados no pescoço formando uma vela dupla?", opcoes: ["Amargassauro", "Espinossauro", "Ouranossauro", "Concavenator"], resposta: 0, explicacao: "Amargasaurus tinha espinhos neurais no pescoço, formando uma vela dupla, usada para termorregulação ou exibição." }
    ]
};
