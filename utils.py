...
def carregar_imagem(nome: str) -> Image.Image:
    ...
    mapa_arquivos = {
    # Dinossauros "clássicos" (mantidos como estão, pois usam imagens sem prefixo)
    ...
    # Dinossauros reais (adicionados recentemente)
    ...
    "Archaeopteryx lithographica": "real_archaeopteryx_lithographica.png",  # ← Aqui!
    ...
    # ... acrescente o Herrerasaurus se houver imagem
}
